...
func TestADJUST_THE_ARRAY(t *testing.T) {
	//TODO
	//a1:=ADJUST_THE_ARRAY()
	//e1:=
	//TEST(true,a1,e1)
...
func ExampleCHECK_DEBIT_EQUAL_CREDIT() {
	//TODO
...
func ExampleCREATE_ARRAY_START_END_MINUTES() {
	//TODO
...
func TestCREATE_ARRAY_START_END_MINUTES(t *testing.T) {
	//TODO
	//a1:=CREATE_ARRAY_START_END_MINUTES()
	//e1:=
	//TEST(true,a1,e1)
...
func TestFIND_COST(t *testing.T) {
	i1 := []PRICE_QUANTITY_ACCOUNT{
		{false, LIFO, "rent", 0, -1},
		{false, WMA, "cash", 0, -1},
	}
...
func ExampleINSERT_ENTRY_NUMBER() {
	//TODO
...
func TestINSERT_ENTRY_NUMBER(t *testing.T) {
	//TODO
	//a1:=INSERT_ENTRY_NUMBER()
	//e1:=
	//TEST(true,a1,e1)
...
func ExampleINSERT_TO_DATABASE() {
	//TODO
...
func TestINSERT_TO_DATABASE(t *testing.T) {
	//TODO
	//a1:=INSERT_TO_DATABASE()
	//e1:=
	//TEST(true,a1,e1)
...
func ExampleINSERT_TO_JOURNAL_TAG() {
	//TODO
...
func TestINSERT_TO_JOURNAL_TAG(t *testing.T) {
	//TODO
	// a1 := INSERT_TO_JOURNAL_TAG()
	// PRINT_SLICE(a1)
	//e1:=
...
func ExampleSET_ADJUSTING_METHOD() {
	//TODO
...
func TestSET_ADJUSTING_METHOD(t *testing.T) {
	//TODO
	//a1:=SET_ADJUSTING_METHOD()
	//e1:=
	//TEST(true,a1,e1)
...
func ExampleSET_DATE_END_TO_ZERO_IF_SMALLER_THAN_DATE_START() {
	//TODO
...
func TestSET_DATE_END_TO_ZERO_IF_SMALLER_THAN_DATE_START(t *testing.T) {
	//TODO
	//a1:=SET_DATE_END_TO_ZERO_IF_SMALLER_THAN_DATE_START()
	//e1:=
	//TEST(true,a1,e1)
...
func ExampleSET_SLICE_DAY_START_END() {
	//TODO
...
func TestSET_SLICE_DAY_START_END(t *testing.T) {
	//TODO
	//a1:=SET_SLICE_DAY_START_END()
	//e1:=
	//TEST(true,a1,e1)
...
func ExampleSHIFT_AND_ARRANGE_THE_TIME_SERIES() {
	//TODO
...
func TestSHIFT_AND_ARRANGE_THE_TIME_SERIES(t *testing.T) {
	//TODO
	//a1:=SHIFT_AND_ARRANGE_THE_TIME_SERIES()
	//e1:=
	//TEST(true,a1,e1)
...
func ExampleSIMPLE_JOURNAL_ENTRY() {
	//TODO
...
func TestTOTAL_MINUTES(t *testing.T) {
	//TODO
	//a1:=TOTAL_MINUTES()
	//e1:=
	//TEST(true,a1,e1)
...
func ExampleVALUE_AFTER_ADJUST_USING_ADJUSTING_METHODS() {
	//TODO
...
func TestVALUE_AFTER_ADJUST_USING_ADJUSTING_METHODS(t *testing.T) {
	//TODO
	//a1:=VALUE_AFTER_ADJUST_USING_ADJUSTING_METHODS()
	//e1:=
	//TEST(true,a1,e1)

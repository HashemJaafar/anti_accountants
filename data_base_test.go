...
func ExampleDB_INSERT_INTO_ACCOUNTS() {
	//TODO
...
func ExampleDB_UPDATE_ACCOUNT_NAME_IN_INVENTORY() {
	//TODO
...
func TestDB_UPDATE_ACCOUNT_NAME_IN_INVENTORY(t *testing.T) {
	//TODO
	//a1:=DB_UPDATE_ACCOUNT_NAME_IN_INVENTORY()
	//e1:=
	//TEST(true,a1,e1)
...
func ExampleDB_UPDATE_ACCOUNT_NAME_IN_JOURNAL() {
	//TODO
...
func TestDB_UPDATE_ACCOUNT_NAME_IN_JOURNAL(t *testing.T) {
	//TODO
	//a1:=DB_UPDATE_ACCOUNT_NAME_IN_JOURNAL()
	//e1:=
	//TEST(true,a1,e1)

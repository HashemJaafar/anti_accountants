...
func TestSimpleJournalEntry(t *testing.T) {
	...
	a1, a2 := SimpleJournalEntry(i1, true, false, false, "ksdfjpaodka", "yasa", "hashem")
	i1 = []PriceQuantityAccountBarcode{
		{1, 1000, "cash", ""},
		{1, 1000, "rent", ""},
	}
	...
	a1, a2 = SimpleJournalEntry(i1, true, false, false, "ksdfjpaodka", "zizi", "hashem")
	DbClose()
...
func TestFindDuplicateElement(t *testing.T) {
	...
	a1, a2 := FindDuplicateElement(dates, journal, TheJournalDuplicateFilter{
		IsReverse:                  false,
		IsReversed:                 false,
...
func TestJournalFilter(t *testing.T) {
	...
	i1 := FilterJournal{
		...
		QuantityCredit:             FilterNumber{IsFilter: true, Way: NotBetween, Big: 999, Small: 0},

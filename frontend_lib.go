...
func Main() {
	...
	l1 := container.New(&DynamicHBoxLayout{Width: 50, Height: 80}, b1, b2, b3)
	l2 := container.New(&DynamicVBoxLayout{Width: 50, Height: 80}, b4, b5, b6)
	l3 := container.New(&DynamicVBoxLayout{Width: 50, Height: 80}, l1, l2)

...
// func make_PRICE_QUANTITY_ACCOUNT_BARCODE_from_JOURNAL_TAG(reverse_entry []JOURNAL_TAG) []PRICE_QUANTITY_ACCOUNT_BARCODE {
// 	var entries_use_PRICE_QUANTITY_ACCOUNT_BARCODE []PRICE_QUANTITY_ACCOUNT_BARCODE
// 	for _, entry := range reverse_entry {
// 		entries_use_PRICE_QUANTITY_ACCOUNT_BARCODE = append(entries_use_PRICE_QUANTITY_ACCOUNT_BARCODE, PRICE_QUANTITY_ACCOUNT_BARCODE{entry.ACCOUNT, entry.VALUE, entry.PRICE, entry.QUANTITY, entry.BARCODE})
// 	}
// 	return entries_use_PRICE_QUANTITY_ACCOUNT_BARCODE
// }
...
// 	can_the_account_be_negative(make_PRICE_QUANTITY_ACCOUNT_BARCODE_from_JOURNAL_TAG(reverse_entry))

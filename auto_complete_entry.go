...
// func auto_completion_the_entry(entries []VALUE_PRICE_QUANTITY_ACCOUNT_BARCODE) []VALUE_PRICE_QUANTITY_ACCOUNT_BARCODE {
// 	var new_entries []VALUE_PRICE_QUANTITY_ACCOUNT_BARCODE
// 	for _, entry := range entries {
// 		for _, complement := range AUTO_COMPLETE_ENTRIES {
// 			if complement.INVENTORY_ACCOUNT == entry.ACCOUNT {
// 				fmt.Println(complement)
// 				new_entries = append(new_entries, VALUE_PRICE_QUANTITY_ACCOUNT_BARCODE{
...
// func auto_completion_the_invoice_discount(entries []VALUE_PRICE_QUANTITY_ACCOUNT_BARCODE) []VALUE_PRICE_QUANTITY_ACCOUNT_BARCODE {
...
// func total_invoice_before_invoice_discount(entries []VALUE_PRICE_QUANTITY_ACCOUNT_BARCODE) float64 {
